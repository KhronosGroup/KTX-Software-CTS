...
texconv -nogpu -nologo -y -m 1 -f BC6H_UF16 -ft dds ${INPUT_DIR}\png\basic_RGB16_16x16.png -o .; Move-Item -Force -Path basic_RGB16_16x16.dds -Destination valid_compressed_BC6H_UFLOAT_16x16.dds
texconv -nogpu -nologo -y -m 1 -f BC6H_SF16 -ft dds ${INPUT_DIR}\png\sbit16_RGB16_16x16.png -o .; Move-Item -Force -Path sbit16_RGB16_16x16.dds -Destination valid_compressed_BC6H_SFLOAT_16x16.dds
...
# DDS volume, cubemap, and array textures
# TODO: these are currently too large and I don't know yet how to assemble them using BC7 compression
